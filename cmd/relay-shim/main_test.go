...
func TestReplyReminder(t *testing.T) {
	r := replyReminder("1000000001")
	for _, want := range []string{"reply tool", `chat_id="1000000001"`, "NOT delivered"} {
...
func TestReplyHandlerSurfacesAckError(t *testing.T) {
	...
	err := handler(context.Background(), "1000000001", "hello")
	if err == nil {
...
func TestReplyHandlerSuccessReturnsNilError(t *testing.T) {
	...
	if err := handler(context.Background(), "1000000001", "hello"); err != nil {
